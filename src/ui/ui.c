...
///////////////////// VARIABLES ////////////////////
lv_anim_t * ExpandingCircle_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * ExpandingCircle_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_1, 0, 240);
...
void ui_destroy(void)
{
    ...
    ui_OutputMatrix_screen_destroy();
}
